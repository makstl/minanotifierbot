...
namespace MinaNotifierBot
{
	public class MinaChartService
    {
        ...
        public MinaChartService(IServiceProvider serviceProvider)
        {
            logger = serviceProvider.GetRequiredService<ILogger<MinaChartService>>();
...
<i>Upd.: {DateTime.UtcNow.ToString("MMM d, HH:mm", formatProvider)} UTC</i>, <a href='https://www.cryptocompare.com/coins/mina/overview'>CryptoCompare</a>";
