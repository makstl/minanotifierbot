...
internal class PriceChart
{
	...
	public void Create(List<OHLC> data, Stream output)
	{
		...
		canvas.DrawImage(SKImage.FromBitmap(SKBitmap.Decode(Assembly.GetExecutingAssembly().GetManifestResourceStream("MinaNotifierBot.Resources." + ImageResource))), 0, 0);
